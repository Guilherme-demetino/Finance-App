    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={() => openCardForm(null)} style={styles.addButton} accessibilityRole="button" accessibilityLabel="Adicionar cartão">
            <Ionicons name="add" size={20} color={colors.textPrimary} />
            <Text style={styles.addText}>Novo cartão</Text>
          </TouchableOpacity>
        </View>
...
const useStyles = makeStyles(({ colors }) => ({
  ...
  // Folga embaixo para a barra de abas flutuante e o botão "+" não cobrirem o fim da lista.
